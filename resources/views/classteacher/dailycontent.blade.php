...
@section('contentdashboard')
    ...
    <div class="card">
        ...
        <div class="card-body">
            @if (auth()->user()->type == 'admin')
                <form action="{{ route('admin.dailycontentfilter') }}" method="GET">
    ...
    <hr class="my-3" />
    <h5 class="fw-bold  mb-3"><span class="text-muted fw-light"></span>Daily Content</h5>
            ...
            <table class="table" id="example">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    @foreach ($contentview as $contentviews)
                        ...
                        <!-- Modal for each row -->
                        <div class="modal fade" id="content{{ $contentviews->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <iframe src="{{ url($contentviews->content_path) }}" type="application/pdf"
    ...
    <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @if (auth()->user()->type == 'admin')
                        <form action="{{ url('admin/dailycontentadd') }}" method="POST" enctype="multipart/form-data">
                        @elseif (auth()->user()->type == 'staff')
                    ...
                    <div class="mb-3">
                        ...
                        {{-- <input type="date" class="form-control" name="date" id="" placeholder="date"
                            ...
                            <input type="date" id="automaticDate" name="date" pattern="\d{4}-\d{2}-\d{2}"
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1">Upload Content</label>
