...
@section('contentdashboard')
    <div class="card p-2">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <small class="text-muted float-end"> <a href="{{ url('/stockdetails') }}"
                    class="btn btn-outline-info btn-sm">Purchase
                    Details</a>
                <a href="{{ url('/returndetails') }}" class="btn btn-info btn-sm">Return Details</a></small>
        </div>
