...
@section('contentdashboard')
    ...
    <h5 class="fw-bold mb-3"><span class="text-muted fw-light"></span>Route Lit</h5>
    
    <div class="card p-2">

    
<small class="float-end"> <a href="{{ url('/accountsadd') }}" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal1" data-bs-whatever="@mdo">Add E-News <i class="fa-solid fa-file-circle-plus"></i>
            </a></small>
