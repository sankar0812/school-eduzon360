    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            @if (auth()->user()->type == 'admin')
                <form action="{{ route('admin.studentcompletedfilter') }}" method="GET">
                @elseif (auth()->user()->type == 'clerk')
                    <form action="{{ route('clerkstudent.studentcompletedfilter') }}" method="GET">
                    @else
                    ...
                    <select class="form-control" name="year" required>
                        ...
                        @if ($Adyear)
                            @foreach ($Adyear as $Adyears)
                                <option value="{{ $Adyears->cr_year }}">ACADEMIC YEAR - {{ $Adyears->oldyear }}</option>
                            @endforeach
                        @endif
