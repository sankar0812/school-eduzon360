...
@section('contentdashboard')
    ...
    <div class="row">
        ...
        <div class="col-md-8">
                        ...
                        <table class="table table-hover table-bordered  border-dark">
                            <tbody>
                                ...
                                <tr>
                                    <td>CERTIFICATE</td>
                                    <td>
                                        <a href="{{ asset($student->file_path) }}" download><i
            ...
            <div class="card mt-1">
                <h6 class="card-header">Previous class</h6>
                <div class="card-body">

                    <div class="table-responsive text-nowrap ">
                        <table class="table table-bordered  border-dark">
                            <tbody>
                                @foreach ($previousclass as $previousclasss)
                                    <tr>
                                        <td>{{ $previousclasss->oldyear }}</td>
                                        <td>{{  $previousclasss->c_class }}</td>
                                    </tr>
                                @endforeach
                                @foreach ($previousct as $previousclasss)
                                <tr>
                                    <td>{{ $previousclasss->oldyear }}</td>
                                    <td>{{  $previousclasss->oldclass_id }}</td>
                                </tr>
                            @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe src="{{ asset($student->file_path) }}" type="application/pdf" width="100%"
                        height="600px"></iframe>
                </div>
